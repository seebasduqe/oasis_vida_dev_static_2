  ...
  return (
    <section className="flexCenter flex-col">
      <div className="padding-container max-container w-full pb-24">
        ...
        <div className="flex flex-wrap justify-between gap-5 lg:gap-10">
          ...
          <p className="regular-16 text-gray-30 xl:max-w-[520px]">
            Only with the hilink application you will longer get lost
            and get lost again, because we already support offline maps
            when there is no internet connection is the field.
      ...
      <div className="flexCenter max-container relative w-full">
        ...
        rounded-3xl border shadow-md md:left-[30%] lg:top-50 lg:left-50">
